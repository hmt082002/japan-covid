...
## Data Sources
- **Kaggle COVID-19 Japan Dataset**: [Kaggle Dataset](https://www.kaggle.com/datasets/lisphilar/covid19-dataset-in-japan)
...
2. **rolling_average_cases.sql**: Calculates the rolling average of COVID-19 cases over a defined period (e.g., 7 days) for smoother trend analysis.
